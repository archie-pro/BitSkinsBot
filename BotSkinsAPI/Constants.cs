...
namespace BotSkinsAPI
{
	public static class Constants
	{
		...
		public static readonly string GetSuggestedItemPrices = "api/v1/get_all_item_prices";
		public static readonly string GetSellItemsPriceFork = "api/v1/get_price_data_for_items_on_sale";
		public static readonly string GetFilteredSellItems = "api/v1/get_inventory_on_sale";
		public static readonly string GetSellItemsById = "api/v1/get_specific_items_on_sale";
		...
		public static readonly string GetSteamItemSalesInfo = "get_steam_price_data";
		public static readonly string GetBitskinsItemSalesInfo = "api/v1/get_sales_info";
		...
		static Constants()
		{
			...
			{
				GetAccountBalance, GetAccountInventory, GetMoneyEvents,
				GetSuggestedItemPrices, GetSellItemsPriceFork, GetFilteredSellItems, GetSellItemsById, GetResetPriceItems, GetRecentTradeOffers, GetTradeDetails, 
				GetBitskinsItemSalesInfo, GetSteamItemSalesInfo, GetBuyHistory, GetSellHistory, GetItemHistory
			};
